...
<head>
    ...
    <title>Prova de JavaScript - P1</title>
    <style>
...
<body>
    <section class="capa">
        ...
        <h1>Prova de JavaScript - P1 - 12/04/2026</h1>
    ...
    <section class="menu">
        ...
        <table>
            <tr>
                ...
                <th class="linha80">JavaScript</th>
            </tr>
            <tr>
                <td class="linha100">Exercício 1</td>
                <td class="linha80"><a href="js/ex01/ex01.html">Abrir</a></td>
            </tr>
            <tr>
                <td class="linha100">Exercício 2</td>
                <td class="linha80"><a href="js/ex02/ex02.html">Abrir</a></td>
            </tr>
            <tr>
                <td class="linha100">Exercício 3</td>
                <td class="linha80"><a href="js/ex03/ex03.html">Abrir</a></td>
            </tr>
            <tr>
                <td class="linha100">Exercício 4</td>
                <td class="linha80"><a href="js/ex04/ex04.html">Abrir</a></td>
            </tr>
            <tr>
                <td class="linha100">Exercício 5</td>
                <td class="linha80"><a href="js/ex05/ex05.html">Abrir</a></td>
            </tr>
        </table>
    </section>
</body>
